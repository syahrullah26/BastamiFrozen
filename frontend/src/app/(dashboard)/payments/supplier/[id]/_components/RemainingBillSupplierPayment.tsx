  ...
  return (
    <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-xs p-6 space-y-4">
      ...
      <button
        ...
        className={`w-full flex items-center justify-center gap-2 py-2.5 text-xs font-bold  ${paymentPercentage < 50 ? "bg-red-50 hover:bg-red-100 border border-red-200 text-red-500 " : paymentPercentage < 95 ? "bg-yellow-50 hover:bg-yellow-100 border border-yellow-200 text-yellow-500" : "bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-500"} rounded-xl transition-all ${payment.supplier.remaining_bill === 0 ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
